    ...
    <AnimatePresence>
      {open && (
        <motion.aside
          ...
          className="fixed right-0 top-24 z-40 h-[calc(100vh-96px)] w-full max-w-[420px] border-l border-slate-200 bg-white shadow-xl transition-colors duration-300 dark:border-slate-700 dark:bg-navy-900/95"
        >
