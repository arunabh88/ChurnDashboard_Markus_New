    ...
    <Card>
      <CardContent className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          <select className="rounded-full border border-slate-200/40 bg-white/5 px-4 py-2 text-sm font-medium text-slate-100 focus:border-sky-300/60 focus:outline-none">
