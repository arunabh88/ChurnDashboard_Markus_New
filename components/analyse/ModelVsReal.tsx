...
export function ModelVsReal({ onTakeAction }: ModelVsRealProps = {}) {
  return (
        ...
        <div className="flex gap-2">
          ...
          {onTakeAction && (
            <motion.button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-sky-500 via-blue-500 to-indigo-500 px-3 py-1.5 text-xs font-semibold text-white shadow-lg shadow-sky-500/30"
            >
              <PlayCircle size={14} />
              Add to Experiment
            </motion.button>
